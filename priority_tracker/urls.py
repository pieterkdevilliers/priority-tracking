...
urlpatterns = [
    ...
    path('filtered-actions/', views.get_filtered_action_list,
            name='get_filtered_action_list'),
    ...
    path('update-priority/<str:pk>/', views.update_priority,
    ...
    path('delete-priority/<str:pk>/', views.delete_priority,
        name='delete_priority'),
    path('complete-action/<str:pk>/', views.complete_action,
        name='complete_action'),
    path('start-timer/<str:pk>/', views.start_timer, name='start_timer'),
    path('stop-timer/<str:pk>/', views.stop_timer, name='stop_timer'),
    path('tracking-status/<str:pk>/', views.tracking_status,
        name='tracking_status'),
    path('priority_active_status/<str:pk>/', views.priority_active_status,
        name='priority_active_status'),
    path('complete-filtered-action/<str:pk>/', views.complete_filtered_action,
        name='complete_filtered_action'),
    path('reset-password/',
